...
public class FragDisplayCentres extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //Creates an instance of the search bar
        EditText searchEditText = view.findViewById(R.id.searchEditText);
        //Sets the onTextChange Listener
        searchEditText.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {searchEditText.setHint("");}
            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                searchEditText.setHint("");
                //sends the values to the adapter
