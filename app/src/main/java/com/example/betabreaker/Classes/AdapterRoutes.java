...
import com.example.betabreaker.FragSpecRoute;
...
public class AdapterRoutes extends RecyclerView.Adapter<AdapterRoutes.ViewHolder> {
    ...
    public AdapterRoutes(List<ClsRoutes> itemList, Context context) {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView, List<ClsRoutes> itemList) {
            super(itemView);
